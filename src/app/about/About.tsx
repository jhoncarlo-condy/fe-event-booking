					...
					<Card className='bg-white shadow-md p-6'>
						<CardContent className='text-gray-700 text-lg space-y-4'>
							...
							<p>
								...
								Whether you&apos;re a developer learning or just exploring, this
								project is an excellent starting point.
							</p>
							<h3 className='text-2xl font-semibold text-gray-800'>
								Disclaimer
							</h3>
							<p>
								...
								intended for real-world event management. No actual bookings or
								transactions take place, and all event data is purely for
